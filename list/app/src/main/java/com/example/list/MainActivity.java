   ...
   /* private HomeAdapter mAdapter;*/
    ...
    class TmpAdapter extends RecyclerView.Adapter<TmpAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            /*return new MyV8   iewHolder(LayoutInflater.from((MainActivity.this).inflate(R.layout.recycler_item,parent,false));*/
        ...
        /*MyViewHolder.iv.setOnClickListener(new View.OnClickListener(){
            ...
            Toast.makeText(MainActivity.this, name + "选择的", Toast.LENGTH_LONG).show();
        }
        });
         return MyViewHolder;*/
    }
